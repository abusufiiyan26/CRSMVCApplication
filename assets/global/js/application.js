...
function switchLanguage() {
    ...
    $('#language-header').on('click', 'ul a', function(e) {
        ...
        if($('body').hasClass('builder-admin') || $('.page-content').hasClass('page-builder') || $('.page-content').hasClass('email-builder') || $('.page-content').hasClass('frontend-builder')) {
            $("[data-translate]").jqTranslate('../../admin//myKKPJentera/assets/plugins/translate/application', {
                forceLang: language
            });
        }
        else{
            $("[data-translate]").jqTranslate('/myKKPJentera/assets/plugins/translate/application', {
                forceLang: language
            });
        }
...
function handleboxedLayout() {
    ...
    if ($('body').hasClass('boxed')) {
        ...
        if (!$('body').hasClass('sidebar-top') && windowWidth > 1220)  {
            ...
            $.backstretch(["/myKKPJentera/images/gallery/bg1.jpg", "/myKKPJentera/images/gallery/bg2.jpg", "/myKKPJentera/images/gallery/bg3.jpg", "/myKKPJentera/images/gallery/bg4.jpg"], {
                fade: 3000,
                duration: 4000
            });
        }
