...
$(document).ready(function() {
    if ($('#map').length) {
        ...
        /* Background Slide */
        $.backstretch([ "/myKKPJentera/images/gallery/login4.jpg", "/myKKPJentera/images/gallery/login3.jpg", "/myKKPJentera/images/gallery/login2.jpg", "/myKKPJentera/images/gallery/login.jpg"],{fade: 600, duration: 4000 
        });
    }
    map_height();
