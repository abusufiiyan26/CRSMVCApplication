$(function() {
    $.backstretch(["/myKKPJentera/images/gallery/login4.jpg", "/myKKPJentera/images/gallery/login3.jpg", "/myKKPJentera/images/gallery/login2.jpg", "/myKKPJentera/images/gallery/login.jpg"], {
        fade: 600,
        duration: 4000
    });
    ...
    /* Background Slide */
    $('.bg-slider').backstretch(["/myKKPJentera/images/gallery/login4.jpg", "/myKKPJentera/images/gallery/login3.jpg", "/myKKPJentera/images/gallery/login2.jpg", "/myKKPJentera/images/gallery/login.jpg"], {
        fade: 600,
        duration: 4000
    });
    ...
    $('#image-cb').change(function() {
        if ($(this).is(":checked")) {
            $.backstretch(["/myKKPJentera/images/gallery/login.jpg"], {
                fade: 600,
                duration: 4000
            });
