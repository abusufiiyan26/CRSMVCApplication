...
{
    public partial class ReportCertificateReg : System.Web.UI.Page
    {
        ...
        protected void LoadReport()
        {
            ...
            try
            {
                ...
                RptViewer.ServerReport.ReportPath = "/ReportOneCRS/CertificateRegistration";
                ...
                Microsoft.Reporting.WebForms.ReportParameter[] Params = new Microsoft.Reporting.WebForms.ReportParameter[9];
                ...
                Params[4] = new Microsoft.Reporting.WebForms.ReportParameter("Media", ddlMedia.SelectedItem.Text, Visible);
                Params[5] = new Microsoft.Reporting.WebForms.ReportParameter("ICNO", txtICNO.Text, Visible);
                Params[6] = new Microsoft.Reporting.WebForms.ReportParameter("RegType", ddlApplicationType.SelectedItem.Text, Visible);
                Params[7] = new Microsoft.Reporting.WebForms.ReportParameter("ApplicationStatus", ddlApplicationStatus.SelectedItem.Text, Visible);
                Params[8] = new Microsoft.Reporting.WebForms.ReportParameter("CertStatus", ddlCertificateStatus.SelectedItem.Text, Visible);
        ...
        private void BindMedia()
        {
            try
            {
                if (ddlMedia.Items.Count > 0)
                {
                    ddlMedia.Items.Clear();
                }
                List<M_MediaBO> lstMedia = new List<M_MediaBO>();
                ReportsBLL bll = new ReportsBLL();
                //get the list of Project 
                lstMedia = bll.GetAllMedia();
                var allMedia = lstMedia.Select(c => new { DisplayText = c.MediaName, Value = c.MediaID });


                ddlMedia.DataValueField = "Value";
                ddlMedia.DataTextField = "DisplayText";
                ddlMedia.DataSource = allMedia;
                ddlMedia.DataBind();
                ddlMedia.Items.Insert(0, new ListItem("All", "0"));
        ...
        private void BindApplicationStatus()
        {
            try
            {
                if (ddlApplicationStatus.Items.Count > 0)
                {
                    ddlApplicationStatus.Items.Clear();
                }
                List<M_StatusBO> lstMedia = new List<M_StatusBO>();
                ReportsBLL bll = new ReportsBLL();
                //get the list of Project 
                lstMedia = bll.GetAllApplicationStatus();
                var allApplicationStatus = lstMedia.Select(c => new { DisplayText = c.Status, Value = c.StatusID});


                ddlApplicationStatus.DataValueField = "Value";
                ddlApplicationStatus.DataTextField = "DisplayText";
                ddlApplicationStatus.DataSource = allApplicationStatus;
                ddlApplicationStatus.DataBind();
                ddlApplicationStatus.Items.Insert(0, new ListItem("All", "0"));
